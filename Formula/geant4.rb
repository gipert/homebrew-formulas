class Geant4 < Formula
  ...
  option "with-motif", "Use Motif libraries"
  option "with-system-clhep", "Use system (homebrew) clhep"
  ...
  def install
    mkdir "geant-build" do
      ...
      args << "-DGEANT4_USE_XM=ON" if build.with? "motif"
      ...
      args << "-DGEANT4_USE_SYSTEM_CLHEP=ON -DCLHEP_ROOT_DIR=/usr/local/Cellar/clhep/2.3.3.1" if build.with? "system-clhep"
