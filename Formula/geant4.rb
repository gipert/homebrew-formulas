class Geant4 < Formula
  ...
  url "https://cern.ch/geant4-data/releases/geant4.10.04.p02.tar.gz"
  version "10.4.2"
  ...
  resource "G4EMLOW" do
    url "https://geant4-data.web.cern.ch/geant4-data/datasets/G4EMLOW.7.3.tar.gz"
    sha256 "583aa7f34f67b09db7d566f904c54b21e95a9ac05b60e2bfb794efb569dba14e"
  end

  resource "PhotonEvaporation" do
    url "https://geant4-data.web.cern.ch/geant4-data/datasets/G4PhotonEvaporation.5.2.tar.gz"
    sha256 "83607f8d36827b2a7fca19c9c336caffbebf61a359d0ef7cee44a8bcf3fc2d1f"
  end

  resource "RadioactiveDecay" do
    url "https://geant4-data.web.cern.ch/geant4-data/datasets/G4RadioactiveDecay.5.2.tar.gz"
